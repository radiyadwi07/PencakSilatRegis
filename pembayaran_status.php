...
include 'akses.php';
$nia = $_SESSION['nia'];
$query = $koneksi->query("SELECT * FROM transaksi WHERE nia = '$nia'");
        ...
        <form method="post" enctype="multipart/form-data" class="mt-5">
    			<div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control" required="" maxlength="35" value="<?php echo $pembayaran['nama_lengkap']; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        <label for="">Total</label>
                        <input type="text" name="total" class="form-control" required="" maxlength="8"> 
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="catatan" class="form-control" required="" maxlength="35">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
        ...
        <?php 
              if (isset($_POST['transaksi'])) {
                ...
                if($query->num_rows != 0) {
                  ...
                  if(!$newnia || !$nama_lengkap || !$email || !$no_telp || !$total|| !$catatan|| !$tgl_transaksi|| !$gambar_path) {
                    ...
                    $query = $koneksi->query("INSERT INTO transaksi (nia,nama_lengkap,email,no_telp,total,catatan,tgl_transaksi,foto_bukti) VALUES ('$newnia','$nama_lengkap','$email','$no_telp','$total','$catatan','$tgl_transaksi','$gambar_path')");
