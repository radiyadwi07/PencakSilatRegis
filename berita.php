          ...
          ?>
              <div class="col-md-3 p-3 ">
                <div class="card" style="height :auto">
                  <img class="card-img-top" src="<?= "assets/images/berita/".$tampil['gambar'] ?>" alt="Card image cap" width="100" height="200">
                  <div class="card-body">
                    <h5 class="card-title"></h5>
                    <p class="card-text">Klik <b>Lihat Detail</b> Untuk Melihat Informasi Terbaru.</p>
                    <a href="detail-berita.php?id=<?= $tampil['id_post']?>" class="btn btn-secondary btn-lg btn-block">Cek Detail
