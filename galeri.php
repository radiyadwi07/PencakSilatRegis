  ...
  <div class="main main-raised">
  	<div class="section section-basic">
          ...
          ?>
  				<div class="col-md-4">
  					<div class="cards">
              <img src="assets/images/foto_galeri/<?php echo $galeri['gambar']; ?>" class="card-img-top" width='100%' height='350'>
              <div class="card-body">
                <p class="mt-2"><i class="fa fa-clock-o text-secondary"></i> <?php echo date('d-m-Y',strtotime($galeri['tanggal'])); ?></p>
                <h5 class="card-title text-uppercase"><?php echo $galeri['nama_galeri']; ?></h5>
              </div>
            </div>
  				</div>
        <?php } ?>
